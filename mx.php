...
<?php $pageTitle = 'Nx Mx — Categories'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="nx-page">
    ...
    <div class="nx-page-header">
        ...
        <div class="nx-header-actions">
            ...
            <button class="nx-btn" type="button" data-toggle="modal" data-target="#addrecord">Add Category</button>
        </div>
    </div>
    ...
    <div class="nx-table-card" style="max-width:600px;">
        <table id="myTable" class="display" style="width:100%" data-order='[[0,"asc"]]'>
            <thead>
                <tr>
                    <th>Index</th><th>Category</th><th>BG Color</th><th>Font Color</th><th>&nbsp;</th>
                </tr>
            </thead>
        </table>
    </div>
...
<!-- Add Category Modal -->
<form action="mxrecordadd.php" method="post">
...
<div class="modal-dialog" role="document" style="max-width:480px;">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <input type="submit" class="btn btn-primary" name="AddRecord" value="Add Category">
        </div>
    </div>
</div>
</div>
...
<form action="mxaction.php" method="post" name="actionForm" id="actionForm">
